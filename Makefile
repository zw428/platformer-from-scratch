...
build/teleporter_test.o: test/teleporter_test.cpp teleporter.cpp collider.cpp collider.h object.cpp object.h manager.cpp manager.h
	$(CC) $(FLAGS) -c -o $@ $<
...
build/anim_test.o: test/anim_test.cpp anim.cpp anim.h image.cpp image.h camera.cpp camera.h
	$(CC) $(FLAGS) -c -o $@ $<
